...
document.addEventListener('DOMContentLoaded', async function(){
	...
	try{
		...
		const childRes = await fetch('/ebakunado/php/supabase/shared/get_child_details.php', { method:'POST', body: fd });
        ...
        const schedRes = await fetch(`/ebakunado/php/supabase/shared/get_immunization_records.php?baby_id=${encodeURIComponent(babyId)}`);
...
async function updateFeedingStatus() {
    ...
    try {
        ...
        const res = await fetch('/ebakunado/php/supabase/shared/update_feeding_status.php', { method: 'POST', body: formData });
...
async function updateTDStatus() {
    ...
    try {
        ...
        const res = await fetch('/ebakunado/php/supabase/shared/update_td_status.php', { method: 'POST', body: formData });
        const data = await res.json();
        if (data.status === 'success') {
...
async function updateImmunizationDate(recordId, newDate) {
    try {
        ...
        const res = await fetch('/ebakunado/php/supabase/shared/update_immunization_date.php', { method: 'POST', body: formData });
        const data = await res.json();
        if (data.status !== 'success') {
...
async function updateImmunizationHeight(recordId, newHeight) {
    try {
        ...
        const res = await fetch('/ebakunado/php/supabase/shared/update_immunization_height.php', { method: 'POST', body: formData });
        const data = await res.json();
        if (data.status !== 'success') {
...
async function updateImmunizationWeight(recordId, newWeight) {
    try {
        ...
        const res = await fetch('/ebakunado/php/supabase/shared/update_immunization_weight.php', { method: 'POST', body: formData });
        const data = await res.json();
        if (data.status !== 'success') {
...
async function updateImmunizationStatus(recordId, newStatus) {
    try {
        ...
        const res = await fetch('/ebakunado/php/supabase/shared/update_immunization_status.php', { method: 'POST', body: formData });
        const data = await res.json();
        if (data.status !== 'success') {
...
async function updateNextScheduleDate(recordId, newDate) {
    try {
        ...
        const res = await fetch('/ebakunado/php/supabase/shared/update_next_schedule_date.php', { method: 'POST', body: formData });
        const data = await res.json();
        if (data.status !== 'success') {
...
async function deleteImmunizationRecord(recordId) {
    ...
    try {
        ...
        const res = await fetch('/ebakunado/php/supabase/shared/delete_immunization_record.php', { method: 'POST', body: formData });
        const data = await res.json();
        if (data.status === 'success') {
