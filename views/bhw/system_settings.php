...
document.getElementById('systemSettingsForm').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('/ebakunado/php/supabase/bhw/save_system_settings.php', {
            method: 'POST',
            body: formData
        });
...
async function testEmailConfig() {
    ...
    try {
        ...
        const response = await fetch('/ebakunado/php/supabase/bhw/test_system_config.php', {
            method: 'POST',
            body: formData
        });
