...
<head>
    ...
    <link rel="stylesheet" href="css/bhw/chr-doc-requests.css?v=1.0.1" />
...
<body>
    ...
    <main>
        <section class="baby-card-request-section">
            <div class="page-header">
                <h1 class="page-title">Baby Card Requests</h1>
            ...
            <div class="data-table-card">
                <div class="data-table-toolbar__top">
                    <div class="data-table-toolbar__titles">
                        <h2 class="data-table-title">Baby Card Requests</h2>
                    </div>
    ...
    <script>
        ...
        async function loadBabycardRequests(page = 1) {
            ...
            try {
                ...
                const res = await fetch(`php/supabase/bhw/list_babycard_doc_requests.php?${params.toString()}`);
