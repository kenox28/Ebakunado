...
<body>
                ...
                <div class="data-table-toolbar data-table-toolbar--stack">
                    ...
                    <div class="data-table-actions">
                        <div class="data-table-search" id="usersSearchWrap">
                            ...
                            <input type="text" id="searchUsers" class="data-table-search__input" placeholder="Search users..." />
    ...
    <script src="js/supabase_js/superadmin/user-management.js?v=1.0.4"></script>
    <script>
        (function() {
            // Search clear toggle
            ...
            clearBtn.addEventListener('click', function() {
                ...
                if (typeof clearSearch === 'function') {
                    clearSearch('searchUsers', 'usersTableBody');
                }
                input.focus();
            });
            toggleClear();
