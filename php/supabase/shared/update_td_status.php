...
try {
    ...
    // Fetch existing row
    $existing = supabaseSelect('mother_tetanus_doses', 'id,dose1_date,dose2_date,dose3_date,dose4_date,dose5_date', ['user_id' => $string_user_id], null, 1);

    // Normalize empty strings to null and build update
